...
import { gender } from "../models/pgEnum";
import { house_role_type, resident_status } from "../models/pgEnum";
...
export const residentSchema = pgTable("resident", {
  ...
  move_in_date: date("move_in_date", { mode: "date" }),
  move_out_date: date("move_out_date", { mode: "date" }),
...
export type Resident = typeof residentSchema.$inferSelect;
export type NewResident = typeof residentSchema.$inferInsert;