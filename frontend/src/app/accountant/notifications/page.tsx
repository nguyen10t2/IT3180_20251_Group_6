...
export default function AccountantNotificationsPage() {
  ...
  const deleteMutation = useMutation({
    ...
    onError: (error) => toast.error(`Xóa thông báo thất bại: ${error instanceof Error ? error.message : 'Lỗi không xác định'}`),
  });

  const createMutation = useMutation({
    mutationFn: (data: typeof formData) => notificationService.createNotification(data, 'accountant'),
    onSuccess: () => {
